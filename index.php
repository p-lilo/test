      ...
      <div class="container">
        ...
        <section class="pt-5">
          ...
          <div class="row">
            ...
            while($brand=$select->fetch_assoc()){
            ?>
            <div class="col-md-4">
              <a class="category-item" href="shop.php?id=<?=$brand['id'];?>">
                <img style="width:70%;height:30%;" class="img-fluid" src="admin/img/brand/<?= $brand['img']; ?>" alt="">
                <strong class="category-item-title"><?= $brand['name'];?></strong>
              </a>
            </div>
            <?php }?>
          </div>
        ...
        <section class="py-5">
          ...
          <div class="row">
            <?php
              $select_pro=$conn->query("SELECT * FROM `products`");
              while($product=$select_pro->fetch_assoc()){
            ?>
            <!-- PRODUCT-->
