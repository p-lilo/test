              ...
              <div class="col-lg-9 order-1 order-lg-2 mb-5 mb-lg-0">
                ...
                <div class="row">
                  <!-- PRODUCT-->
                    ...
                    $ID=$_GET['id'];
                    $select=$conn->query("SELECT * FROM `products` WHERE brand=$ID");
                  ...
                  <div class="col-lg-4 col-sm-6">
                    <div class="product text-center">
                      <div class="mb-3 position-relative">
                        ...
                        <?php
                          $Id=$res['id'];
                          $query=$conn->query("SELECT * FROM `product_image` WHERE pro_id=$Id limit 1");
                        while($img=$query->fetch_assoc()){ ?>
                        <a class="d-block" href="detail.php?id=<?= $res['id'];?>">
                        
                          <img style="height:250px ;" class="img-fluid w-100" src="admin/img/makeup/<?php echo $img['image'];?>" alt="...">
                        </a>
                        <?php } ?>
                        <div class="product-overlay">
                          <ul class="mb-0 list-inline">
                            ...
                            <li class="list-inline-item m-0 p-0">
                              <a class="btn btn-sm btn-dark" href="cart.php">Add to cart</a>
                            </li>
                      ...
                      <h6> <a class="reset-anchor" href="detail.php"><?= $res['name']; ?></a></h6>
                      <p class="small text-muted"><?= $res['price']; ?>$</p>
                    </div>
                  </div>
