          ...
          <div class="row mb-5">
            <div class="col-lg-6">
              ...
              <div class="row m-sm-0">
                ...
                $Id=$_GET['id'];
                $select=$conn->query("SELECT * FROM `product_image` WHERE pro_id=$Id");
                while($res=$select->fetch_assoc()){
                  ?>
                    <div class="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0">
                      <img style="height:100px ;" class="w-100" src="admin/img/makeup/<?= $res['image'];?>" alt="...">
                    </div>
                    <?php }?>
                  </div>
                </div>
                <div class="col-sm-10 order-1 order-sm-2">
                  <div class="owl-carousel product-slider" data-slider-id="1">
                    ...
                    ?>
                    <a class="d-block" href="admin/img/makeup/<?= $res['image'];?>" data-lightbox="product" title="Product item 1">
                      <img class="img-fluid" src="admin/img/makeup/<?= $res['image'];?>" alt="...">
                    </a>
                    <?php }?>
                    </a>
                  </div>
            ...
            $select_pro=$conn->query("SELECT * FROM `products` WHERE  id=$Id");
            $res_pro=$select_pro->fetch_assoc();
            ?>
            <div class="col-lg-6">
              <ul class="list-inline mb-2">
                <li class="list-inline-item m-0"><i class="fas fa-star small text-warning"></i></li>
              ...
              <h1><?= $res_pro['name'];?></h1>
              <p class="text-muted lead">$<?= $res_pro['price'];?></p>
              <p class="text-small mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In ut ullamcorper leo, eget euismod orci. Cum sociis natoque penatibus et magnis dis parturient montes nascetur ridiculus mus. Vestibulum ultricies aliquam convallis.</p>
              <div class="row align-items-stretch mb-4">
