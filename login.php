...
<html>
  ...
  <body>
    <div class="page-holder">
     ...
     ?>
     <div class="container" style="border: 1px solid black;margin:5%;padding:3%">
    <form>
    <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="number" name="age"class="form-control age" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
    <label  class="form-label">Password</label>
    <input type="password" name="pass"class="form-control pass" id="exampleInputPassword1">
  </div>
  <div class="mb-3">
